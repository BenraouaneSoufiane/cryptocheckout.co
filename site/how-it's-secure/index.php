...
<header>
    ...
    <div id="greeting" style="position: relative;width: 55%;margin-right:auto;margin-left:auto;margin-top:80px">
        ...
        <p style="text-align: center;font-size: 18px;line-height: 1.5;">2- Matching transation amount & paid address with the received amount using the associated blochain explorer (this included also checking number of confirmation or status success depending on crypto currency type)</p><br/>             
