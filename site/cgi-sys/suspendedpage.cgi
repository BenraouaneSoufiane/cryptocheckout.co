...
<html><head>
    ...
    <link rel="stylesheet" href="suspendedpage.cgi_fichiers/all.css">
    <style type="text/css">
        body {
            ...
            <div class="container">
                <div class="additional-info-items">
                    ...
                    <div class="reason-text">
                        <a href="mailto:webmaster@rates.hirak.site" id="dynamicProviderLink" title="webmaster@rates.hirak.site" rel="noopener noreferrer">Contact your hosting provider</a> for more information.
                    </div>
                </div>
            </div>
        </section>
